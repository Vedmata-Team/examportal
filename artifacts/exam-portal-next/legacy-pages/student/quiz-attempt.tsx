      ...
      <div className="min-h-screen flex items-center justify-center bg-background p-4">
        <Card className="w-full max-w-md">
          ...
          <CardContent className="text-center space-y-4">
            ...
            <Button onClick={() => router.push("/student/results")} className="w-full" data-testid="button-view-results">
              View All Results
            </Button>
            <Button variant="outline" onClick={() => router.push("/student/chapters")} className="w-full" data-testid="button-back-chapters">
              Back to Chapters
            </Button>
          </CardContent>
        </Card>
